                                        ...
                                        <div class="col-10 col-lg-11 align-self-center">
                                            <div class="row">
                                                <div class="col-12 col-lg-6 align-self-center">
                                                    <input type="number" name="postal_code" class="form-control required numbersOnly" placeholder="例：1234567" onKeyUp="AjaxZip3.zip2addr(this,'','prefecture','city', 'chome_address')">
                                                </div>
                                                <div class="col-12 col-lg-6 align-self-center">
