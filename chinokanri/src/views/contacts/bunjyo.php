                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link flex-fill active" id="nav-propertysale-tab" href="http://html-static.fudosan-king.jp/chinokanri/bunjyo.php" role="tab" aria-controls="nav-propertysale" aria-selected="false"><span>当社管理分譲物件に<br>関するお問合せ</span></a>
                                <a class="nav-item nav-link flex-fill" id="nav-cancellation-tab" href="http://html-static.fudosan-king.jp/chinokanri/kaiyaku.php" role="tab" aria-controls="nav-cancellation" aria-selected="false"><span>解約に関するお問合せ</span></a>
                                    ...
                                    <form action="http://go.pardot.com/l/185822/2020-07-19/qb1ql7" data-action-url="http://go.pardot.com/l/185822/2020-07-19/qb1ql7" class="frm_general needs-validation" novalidate id="form-bunjyo" method="POST">
                                        <div class="frm_general_content">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-10 col-lg-11 align-self-center">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-6 align-self-center">
                                                                <button type="button" class="btnAuto btn mt-2 mt-lg-0 btn-link" onClick="AjaxZip3.zip2addr('postal_code','','prefecture','city', 'chome_address')"><img src="./千野建物管理株式会社_files/arrow_right.png" width="20" alt="" class="img-fluid"> 郵便番号から住所を自動的入力</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="box_content_footer">
                                                ...
                                                個人情報の取扱に関しましては <a class="btn-link" href="http://html-static.fudosan-king.jp/chinokanri/bunjyo.php#"><b>プライバシーポリシー</b></a> をご覧ください。<br>
