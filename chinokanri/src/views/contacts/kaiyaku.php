                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link flex-fill" id="nav-previewrequest-tab" href="http://html-static.fudosan-king.jp/chinokanri/index.php" role="tab" aria-controls="nav-previewrequest" aria-selected="true"><span>内見依頼に関する<br>お問合せ</span></a>
                                <a class="nav-item nav-link flex-fill" id="nav-rentalproperty-tab" href="http://html-static.fudosan-king.jp/chinokanri/chintai.php" role="tab" aria-controls="nav-rentalproperty" aria-selected="false"><span>当社管理賃貸物件に<br>関するお問合せ</span></a>
                                <a class="nav-item nav-link flex-fill" id="nav-propertysale-tab" href="http://html-static.fudosan-king.jp/chinokanri/bunjyo.php" role="tab" aria-controls="nav-propertysale" aria-selected="false"><span>当社管理分譲物件に<br>関するお問合せ</span></a>
                                <a class="nav-item nav-link flex-fill active" id="nav-cancellation-tab" href="http://html-static.fudosan-king.jp/chinokanri/kaiyaku.php" role="tab" aria-controls="nav-cancellation" aria-selected="false"><span>解約に関するお問合せ</span></a>
                                <a class="nav-item nav-link flex-fill" id="nav-management-tab" href="http://html-static.fudosan-king.jp/chinokanri/important.php" role="tab" aria-controls="nav-management" aria-selected="false"><span>管理に関わる<br>重要事項調査報告書作成<br>の依頼</span></a>
                            </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-10 col-lg-11 align-self-center">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-6 align-self-center">
                                                                <button type="button" class="btnAuto btn mt-2 mt-lg-0 btn-link" href="http://html-static.fudosan-king.jp/chinokanri/kaiyaku.php#" onclick="AjaxZip3.zip2addr('contract_estate_postal_code','','contract_estate_pref','contract_estate_city', 'contract_estate_chome_address')"><img src="./千野建物管理株式会社_files/arrow_right.png" width="20" alt="" class="img-fluid"> 郵便番号から住所を自動的入力</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-10 col-lg-11 align-self-center">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-6 align-self-center">
                                                                <button type="button" class="btnAuto btn mt-2 mt-lg-0 btn-link" href="http://html-static.fudosan-king.jp/chinokanri/kaiyaku.php#" onclick="AjaxZip3.zip2addr('relocation_postal_code','','relocation_refectures','relocation_city')"><img src="./千野建物管理株式会社_files/arrow_right.png" width="20" alt="" class="img-fluid"> 郵便番号から住所を自動的入力</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-10 col-lg-11 align-self-center">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-6 align-self-center">
                                                                <a class="btnAuto btn mt-2 mt-lg-0" href="http://html-static.fudosan-king.jp/chinokanri/kaiyaku.php#" onclick="AjaxZip3.zip2addr('emergency_postal_code','','emergency_refectures','emergency_city','emergency_location_number')"><img src="./千野建物管理株式会社_files/arrow_right.png" width="20" alt="" class="img-fluid"> 郵便番号から住所を自動的入力</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
