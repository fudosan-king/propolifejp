                                                ...
                                                <div class="col-10 col-lg-11 align-self-center">
                                                    <div class="row">
                                                        <div class="col-12 col-lg-6 align-self-center">
                                                            <input type="text" class="form-control required numbersOnly" placeholder="例：1234567" name="contract_estate_postal_code" onkeyup="AjaxZip3.zip2addr(this,'','contract_estate_pref','contract_estate_city', 'contract_estate_chome_address')">
                                                        </div>
                                                        <div class="col-12 col-lg-6 align-self-center">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-10 col-lg-11 align-self-center">
                                                    <div class="row">
                                                        <div class="col-12 col-lg-6 align-self-center">
                                                            <input type="text" class="form-control required numbersOnly" placeholder="例：1234567" name="relocation_postal_code" onkeyup="AjaxZip3.zip2addr(this,'','relocation_refectures','relocation_city')">
                                                        </div>
                                                        <div class="col-12 col-lg-6 align-self-center">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-10 col-lg-11 align-self-center">
                                                    <div class="row">
                                                        <div class="col-12 col-lg-6 align-self-center">
                                                            <input type="text" class="form-control required numbersOnly" placeholder="例：1234567" name="emergency_postal_code" onkeyup="AjaxZip3.zip2addr(this,'','emergency_refectures','emergency_city','emergency_location_number')">
                                                        </div>
                                                        <div class="col-12 col-lg-6 align-self-center">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-10 col-lg-11">
                                                    <div class="box_datetime mb-3">
                                                        <input type="text" class="form-control datepickerCancel required" name="cancellation_date">
