      ...
      <div class="row">
         <div class="col-12">
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
               ...
               <a class="nav-item nav-link flex-fill <?php echo $segment == 'bunjyo' ? 'active' : ''; ?>" id="nav-propertysale-tab" href="<?=base_url();?>contact/bunjyo" role="tab" aria-controls="nav-propertysale" aria-selected="false"><span>当社管理マンションに<br>関するお問い合わせ</span></a>
               ...
               <a class="nav-item nav-link flex-fill <?php echo $segment == 'others' ? 'active' : ''; ?>" id="nav-others-tab" href="<?=base_url();?>contact/others" role="tab" aria-controls="nav-others" aria-selected="true"><span>その他のお問い合わせ</span></a>
            </div>
         </div>
      </div>
   </div>
