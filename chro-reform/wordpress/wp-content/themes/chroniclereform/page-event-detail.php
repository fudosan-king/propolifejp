...
<link rel="stylesheet" type="text/css" href="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/candy/event/css/style.css">
	    ...
	    if (typeof getQueryStr()['p'] !== 'undefined'){
	        ...
	        $.get('https://works-event.chronicle-web.com/event/' + pID, function(data){
	            ...
	            $('#main-data').find('a').each(function(){
	               $(this).attr('href', baseURI.substring(0, baseURI.indexOf('.com/') + 5) + 'reform/event/');
	            });
