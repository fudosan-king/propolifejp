...
<article class="boxArticle">
  ...
  <div id="main-data">
    ...
    <script>
      ...
      $.get('https://works-event.chronicle-web.com/event_pref/nagoya/' + numPage, function(data){
        ...
        $('#container-data #localNav').find('a').each(function(){
          ...
          $('#container-data').find('.pager a').each(function(){
            ...
            $(this).attr('href', $(this).prop('baseURI').substring(0, $(this).prop('baseURI').indexOf('.com/') + 5) + 'reform/event_pref-nagoya/?page=' + pageNum);
           });
