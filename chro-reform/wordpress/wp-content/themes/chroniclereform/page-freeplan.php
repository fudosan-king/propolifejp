...
<!--======== ▼プラン選択 start ===========-->
<div class="boxPlanSelect boxInner">
...
<!--======== ▼自由設計プランとは start ===========-->
<article class="boxArticle boxFreePlan boxInner clearfix">
	<div class="fltL">
	<h1 class="ttlArticle">自分流でとにかくこだわりたい！<br>
	専属プランナーと作る自由設計プラン</h1>
	<section class="boxSection">
	<dl>
	<dt class="mb20">自由設計プランとは？</dt>
	<dd>
	<p class="mb30">「こだわりのある暮らしはこだわりのある生活空間から」「とにかく自分流の暮らしを実現したい」そんなお客さまと一緒に、最高のお家を作り上げていくのがクロニクルリフォームの自由設計プランです。</p>
	<p>たとえば、猫専用の出入り口や遊びスペースのあるペットと暮らす家、男のロマンを詰め込んだこだわりのガレージ風のお家など、お客さまの無限のアイデアとこだわりをクロニクルリフォームが最高のご提案で実現します。</p>
	</dd>
	</dl>
	</section>
	</div>
...
<article id="works01" class="boxArticle">
	...
	<p class="mb50 txtC">2014年6月に竣工したD様邸。 <br>
	思わず目を奪われてしまう壁一面に設置された可動式棚と、天然無垢材をあしらったアイランド型キッチンにこだわって作り上げたお部屋です。 <br>
	可動式棚は収納と陳列を兼ねていて、部屋全体をおしゃれに演出してくれます。 <br>
	フローリング、キッチン、棚板すべてに樺桜を使用しましたので、とても明るく優しい雰囲気に仕上がっているのもポイントです。</p>
