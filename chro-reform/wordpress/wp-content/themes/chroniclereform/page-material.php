...
<!--======== ▼Introduction start ===========-->
<article id="introduction" class="boxArticle boxInner boxMaterial">
...
<!--======== ▼Detail start ===========-->
<article id="detail" class="boxArticle bgGrey boxMaterial">
	<header class="boxArticleHead boxInner">
	<h1 class="ttlArticle mb60 txtC">暮らしに、人に、環境に優しい自然素材。<br>クロニクルリフォームではこれまでの数多くの施工実績からこれらの自然素材をおすすめしています。
	</h1>
	</header>
	...
	<dd>
		<dl>
		<dt class="ttlBalloon"><span>特徴</span></dt>
		<dd>肌触りがよいのはもちろん、断熱性はコンクリートの約2倍と言われ、冬はあたたかく、夏は涼しく快適に暮らせます。
		</dd>
		<dt class="ttlBalloon"><span>用途</span></dt>
		...
		<dd class="boxTwoColumn clearfix">
			...
			<dd>
				<ul class="liDot">
				<li>上がり框、式台、高級家具等によく使われる銘木の一つ</li>
				<li>強勒で硬く重い木質で傷がつきにくい</li>
				<li>人通りが多い商業施設やホテルなどでの使用にも適している</li>
				<li>鮮やかな天然赤色と美しい木目が印象的</li>
				<li>漢字表記は「花梨」。果実酒などで使われるバラ科の「花輪」とは別の樹種</li>
				<li>表面は磨くとより光沢が生まれる</li>
				</ul>
			</dd>
			</dl>
		</dd>
		...
		<dd class="boxTwoColumn clearfix">
			...
			<dd>
				<ul class="liDot">
				<li>チークやマホガニー、ローズウッド等と並び称される最高級樹種の一つ</li>
				<li>時間をかけて生長するため、衝撃に強く、耐久性も高い</li>
				<li>軽量で加工しやすい材質</li>
				<li>重厚感のある深いこげ茶色・墨絵のような美しい木目が特徴</li>
				<li>高級家具やアート彫刻など装飾性の高い用途にも幅広く使用されている</li>
				<li>使い込むほどに味わいが出る人気の樹種</li>
				</ul>
			</dd>
			</dl>
			</dd>
			...
			<dd>
				<ul class="liDot">
				<li>ブナ科コナラ属の総称で、一般的に「ナラ（楢）」と呼ばれる</li>
				<li>はっきりとした美しい木目が特徴で、昔から日本ではよく使われている</li>
				<li>材質は、硬くて重厚。耐久性にも優れている</li>
				<li>住宅はもちろん店舗や公共施設などのフローリング材にも大変適した樹種</li>
				<li>家具や洋酒の樽などにも多く用いられている</li>
				</ul>
			</dd>
			</dl>
			</dd>
			...
			<dd>
				<ul class="liDot">
				<li>最高級木材の一つで、別名「木の王様」</li>
				<li>耐久性に加え、良質の油分を多く含み、塩水などにも強い</li>
				<li>豪華客船の甲板や内装材などによく使われる</li>
				<li>伸縮が非常にすくなく、腐りや虫食い(シロアリ)にも強い</li>
				<li>重厚感に満ちた表情と色合いは、経年劣化による色あせが目立ちにくい</li>
				</ul>
			</dd>
			</dl>
			</dd>
			...
			<dd>
				<ul class="liDot">
				<li>カバノキ科シラカンバ属の落葉広葉樹</li>
				<li>やさしい光沢のある淡いピンク色と白色をした美しい銘木</li>
				<li>お部屋全体を明るく清潔感あふれる印象にする</li>
				<li>硬材の一種で耐久性は十分ながら、肌目が大変緻密で肌触りはやわらか</li>
				</ul>
			</dd>
			</dl>
		</dd>
	...
	<dd>
		<p class="mb20">植物性プランクトン「珪藻」の殻の化石からできた珪藻土は、超多孔構造をもつ自然素材の軽土です。木炭の約５０００倍といわれるミクロサイズの孔が多数あいているため、多くの水や空気を含むことができるのが大きな特徴。近年、シックハウス症候群や化学物質過敏症による健康被害が問題となり、環境・健康にやさしい自然素材として注目を浴びています。</p>
		<dl>
		...
		<dd class="boxTwoColumn clearfix">
			...
			<li>脱湿効果で結露を軽減し、カビ・ダニが発生しづらくなります</li>
			<li>脱臭性が高く、ペットやタバコによる匂い・汚れを軽減します</li>
			<li>超多孔構造が持つ吸音効果で室内外の雑音を遮断。防音効果が期待できます</li>
			</ul>
		</dd>
		</dl>
	</dd>
	...
	<dd>
		<p class="mb20">石灰岩から生成された消石灰を主成分とする自然素材。防水性があり、調湿機能にも優れ、古くからさまざまな国、地域で使用されています。塗り方でさまざまなスタイルに仕上げることができ、また近年ではホルムアルデヒドの吸着分解機能があるとして、健康素材としても評価を得ています。</p>
		<dl>
		<dt class="ttlBalloon"><span>メリット</span></dt>
		<dd class="boxTwoColumn clearfix">
			...
			<li>昔からある歴史的建造物にも多く利用されている。耐久性のある素材で、安定した壁材として人気</li>
			</ul>
		</dd>
		</dl>
	</dd>
