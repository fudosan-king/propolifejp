...
<script type="text/javascript" src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/js/jquery.pagenav.js"></script>
<!-- Google Tag Manager -->
...
<article class="boxArticle">
	...
	<h1 class="ttlArticle"><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/ttl-service-onestop.png" alt="ワンストップサービスだからスピーディ＆リーズナブル＆わかりやすい"></h1>
	</header>
	...
	<section id="step01" class="boxSection boxServiceStep">
		...
		<p class="imgStep fltL"><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/img-step01.jpg" alt="STEP01"></p>
		<dl class="boxStep fltR">
		<dt><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/ttl-step01.png" alt="STEP01 なんでも相談会"></dt>
	...
	<section id="step02" class="boxSection boxServiceStep">
		<div class="boxInner clearfix">
		<p class="imgStep fltL"><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/img-step02.jpg" alt="STEP02"></p>
		<dl class="boxStep fltR">
		<dt><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/ttl-step02.png" alt="STEP02 現地調査０円"></dt>
	...
	<section id="step03" class="boxSection boxServiceStep">
		<div class="boxInner clearfix">
		<p class="imgStep fltL"><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/img-step03.jpg" alt="STEP03"></p>
		<dl class="boxStep fltR">
		<dt><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/ttl-step03.png" alt="STEP03 設計費＆お見積り０円"></dt>
	...
	<section id="step04" class="boxSection boxServiceStep">
		<div class="boxInner clearfix">
		<p class="imgStep fltL"><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/img-step04.jpg" alt="STEP04"></p>
		<dl class="boxStep fltR">
		<dt><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/ttl-step04.png" alt="STEP04 ご納得ゆくまでお打合せ０円"></dt>
	...
	<section id="step05" class="boxSection boxServiceStep">
		<div class="boxInner clearfix">
		<p class="imgStep fltL"><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/img-step05.jpg" alt="STEP05"></p>
		<dl class="boxStep fltR">
		<dt><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/ttl-step05.png" alt="STEP05 ご契約"></dt>
	...
	<section id="step06" class="boxSection boxServiceStep">
		<div class="boxInner clearfix">
		<p class="imgStep fltL"><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/img-step06.jpg" alt="STEP06"></p>
		<dl class="boxStep fltR">
		<dt><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/ttl-step06.png" alt="STEP06 着工"></dt>
	...
	<section id="step07" class="boxSection boxServiceStep">
		<div class="boxInner clearfix">
		<p class="imgStep fltL"><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/img-step07.jpg" alt="STEP07"></p>
		<dl class="boxStep fltR">
		<dt><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/ttl-step07.png" alt="STEP07 完了・お引越し"></dt>
	...
	<section id="step08" class="boxSection boxServiceStep">
		<div class="boxInner clearfix">
		<p class="imgStep fltL"><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/img-step08.jpg" alt="STEP08"></p>
		<dl class="boxStep fltR">
		<dt><img src ="https://www.chronicle-web.com/reform/wordpress/wp-content/themes/chroniclereform/commonfiles/img/service/ttl-step08.png" alt="STEP08 アフターサービス０円"></dt>
