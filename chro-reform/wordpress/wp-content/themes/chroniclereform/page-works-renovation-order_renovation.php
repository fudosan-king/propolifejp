...
<article class="boxArticle">
    ...
    <script>
        ...
        $.get('https://works-event.chronicle-web.com/works/renovation/order_renovation/' + numPage, function(data){
          ...
          $('#container-data #localNav').find('a').each(function(){
            ...
            strPath = strPath + '/';
            $('#container-data').find('a[href="'+ $(this).attr('href') +'"]').each(function(){
               $(this).attr('href', $(this).prop('baseURI').substring(0, $(this).prop('baseURI').indexOf('.com/') + 5) + 'reform/' + strPath);
               // $(this).attr('target', '_blank');
            });
          });
          ...
          $('#container-data').find('.pager a').each(function(){
            ...
            $(this).attr('href', $(this).prop('baseURI').substring(0, $(this).prop('baseURI').indexOf('.com/') + 5) + 'reform/works/renovation/order_renovation/?page=' + pageNum);
           });
