...
<nav class="boxBreadcrumb boxInner">
	...
	<span><a href="<?php if ($_SERVER['HTTP_X_CUSTOM_REFERRER']) { echo $_SERVER['HTTP_X_CUSTOM_REFERRER']; } else { bloginfo('url'); } ?>/blog/">スタッフブログ</a> » </span>
	<span><?php single_term_title('', true); ?></span>
	</p>
</nav>
<!--======== //Breadcrumb end ===========-->
...
<h2 class="ttlarchive">カテゴリ：<?php single_term_title('', true); ?>の投稿一覧</h2>
