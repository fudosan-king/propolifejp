            ...
            <div id="btm_recommend">
                ...
                <div id="btm_banner">
                    ...
                    <ul>
                        ...
                        $banner_img = wp_get_attachment_image_url(get_sub_field('footer_banner_img')['ID'], 'large');
                        $banner_url = get_sub_field('footer_banner_url');
                        ?>
                        <li><a href="<?php echo $banner_url; ?>" target="_blank"><img src="<?php echo $banner_img; ?>" width="235" height="74" alt="<?php echo $banner_title; ?>"></a></li>
                        <?php endwhile; ?>
                        <?php endforeach; ?>
                        <?php wp_reset_postdata(); ?>
                    </ul>
