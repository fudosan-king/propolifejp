            ...
            <div id="point">
                ...
                <ul>
                    <?php
                        ...
                        $point_image = wp_get_attachment_image_url(get_sub_field('point_table_img')['ID'], 'large');
                        $point_image_alt = get_sub_field('point_table_img')['alt'];
                    ?>
                    <li><img src="<?php echo $point_image; ?>" width="190" alt="<?php echo $point_image_alt; ?>"></li>
                    <?php endwhile; ?>
                </ul>
            </div><!-- // #point -->
                ...
                <ul>
                    <?php
                        ...
                        while(the_repeater_field('estate_table')):
                            ...
                            if(get_sub_field('estate_img')){
                                $estate_img = wp_get_attachment_image_url(get_sub_field('estate_img')['ID'], 'large');
                    ...
                    <li>
                        <p class="pic">
                            <?php if(isset($estate_img) && !empty($estate_img)): ?>
                                <img src="<?php echo $estate_img; ?>" width="205" alt="<?php echo $estate_title; ?>">
                            <?php endif; ?>
                        </p>
