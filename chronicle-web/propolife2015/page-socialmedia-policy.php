...
<?php show_topicpath(); ?>
    ...
    <div id="section_title">
        <h2><img src="<?php bloginfo('template_directory'); ?>/common/images/policy/img_title_h2_social.png" style="height:42px; max-width:680px;" alt="SOCIAL MEDIA PRIVACY POLICY"></h2>
