...
<script>
    ...
    $.get('https://works-event.chronicle-web.com/works/renovation/log_mansion/<?php echo $numPage; ?>' , function(data){
      ...
      $('#container-data').find('.pager a').each(function(){
        ...
        $(this).attr('href',  $(this).prop('baseURI').substring(0, $(this).prop('baseURI').indexOf('.com/') + 5) + 'works/renovation/log_mansion/?page=' + pageNum);
       });
