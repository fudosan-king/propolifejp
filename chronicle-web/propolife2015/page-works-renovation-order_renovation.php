...
<?php show_topicpath(); ?>
    ...
    <div id="section_title">
        <h2><img src="<?php bloginfo('template_directory'); ?>/common/images/works/img_title_h2_social.png" style="height:42px; max-width:680px;" alt="WORKS"></h2>
    ...
    <div id="contents_inner">
        <div id="section_works">
            <p class="works"><?php echo $top_text; ?></p>
...
<script>
    ...
    $.get('https://works-event.chronicle-web.com/works/renovation/order_renovation/<?php echo $numPage; ?>' , function(data){
      ...
      $('#container-data').find('.imgBox > a').each(function(){
        ...
        $('#container-data').find('a[href="'+ $(this).attr('href') +'"]').each(function(){
           $(this).attr('href', $(this).prop('baseURI').substring(0, $(this).prop('baseURI').indexOf('.com/') + 5) +'works-detail/?p=' + pID);
      ...
      $('#container-data').find('.pager a').each(function(){
        ...
        $(this).attr('href',  $(this).prop('baseURI').substring(0, $(this).prop('baseURI').indexOf('.com/') + 5) + 'works/renovation/order_renovation/?page=' + pageNum);
       });
