<?php global $tw_lang;
    $tw_text;
    if($tw_lang == 'ja'){ $tw_text = '私は、ここがいい。株式会社クロニクル';}
    else if($tw_lang == 'en'){ $tw_text = 'Bringing Freedom and Wonder to Residences CHRONICLE'; }
    else if($tw_lang == 'zh-cn'){ $tw_text = '赋予“住宅”自由与浪漫。CHRONICLE';}
?>
<div id="sns">
    <ul>
