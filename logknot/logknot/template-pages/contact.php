                    ...
                    <div class="col-12">
                        ...
                        <form action="http://go.pardot.com/l/185822/2020-08-31/qh1njf" method="POST" role="form" class="frm_contact">
                            ...
                            <div class="form-group">
                                ...
                                <textarea  name="free_detail_contact " class="form-control required" style="min-height: 200px;"></textarea>
                            </div>
                            ...
                            <div class="form-group mt-5 text-center">
                                <button type="button" id="ibtnGoSubmit" class="btn btnSend">上記に同意して送信</button>
                            </div>
                        </form>
                    </div>
                </div>
