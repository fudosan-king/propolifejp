...
$logo_url = 'https://www.logrenove.jp/wp-content/themes/logrenove/assets/images/1x/logo_.png';
$no_image_url = 'https://www.logrenove.jp/wp-content/themes/logrenove/assets/images/1x/logo_.png';
...
<channel>
  ...
  <item>
    ...
    <?php endif; ?>
    <enclosure url="<?=$img?>" type="<?=wp_check_filetype($img)['type'];?>"></enclosure>
    <?php //rss_enclosure(); ?>
    <?php
    /**
...
ga('set', 'referrer', 'http://www.antenna.jp/');
