...
<div class="login_page">
    <div class="login_header">
        ...
        <a href="<?php echo get_home_url(); ?>" class="logo logo_md"><img src="<?=IMAGE_PATH;?>/1x/logo_.svg" class="img-fluid" width="250"></a>
        <a href="<?php echo get_home_url(); ?>" class="logo logo_sm"><img src="<?=IMAGE_PATH;?>/1x/logo_.svg" class="img-fluid" width="250"></a>
                            ...
                            <ul>
                                <li class="flex-fill">
                                    <div class="row no-gutters">
                                        <div class="col-3 col-lg-12">
                                            <a href="#">
                                                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/i_01.svg' ?>" alt="" class="img-fluid" width="100">
                                            </a>
                                        </div>
                                ...
                                <li class="flex-fill">
                                    <div class="row no-gutters">
                                        <div class="col-3 col-lg-12">
                                            <a href="#">
                                                <img src="<?php echo get_stylesheet_directory_uri(). '/assets/images/i_03.svg' ?>" alt="" class="img-fluid" width="100">
                                            </a>
                                        </div>
                                        <div class="col-9 col-lg-12">
                                            <div class="benefit_smember_content">
                                ...
                                <li class="flex-fill">
                                     <div class="row no-gutters">
                                        <div class="col-3 col-lg-12">
                                            <a href="#">
                                                <img src="<?php echo get_stylesheet_directory_uri(). '/assets/images/i_04.svg' ?>" alt="" class="img-fluid" width="100"></a>
                                        </div>
                                        <div class="col-9 col-lg-12">
                                            <div class="benefit_smember_content">
                                ...
                                <li class="flex-fill">
                                    <div class="row no-gutters">
                                        <div class="col-3 col-lg-12">
                                            <a href="#"><img src="<?php echo get_stylesheet_directory_uri(). '/assets/images/i_05.svg' ?>" alt="" class="img-fluid" width="100"></a>
                                        </div>
                                        <div class="col-9 col-lg-12">
                                            <div class="benefit_smember_content">
...
<div class="container">
    ...
    <div class="login_body">
        <form method="post" id="frm_signup" class="frm_main_login" action="<?php echo esc_url(network_site_url(add_query_arg('action', $_GET['action']))); ?>">
