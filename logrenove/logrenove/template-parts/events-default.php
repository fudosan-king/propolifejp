            ...
            <div class="col-12 col-lg-4">
                <div class="box_event_item">
                    ...
                    <div class="box_event_item_content">
                        ...
                        <a class="goto_frm_services" href="<?php the_permalink(); ?>#frm_services">
                            <!-- <p class="online_seminar">オンラインリノベセミナー</p> -->
                            <h3><?php the_title();?></h3>
                        </a>
                        <p class="time"><?php echo $even_datetime['date'].' '.$even_datetime['time'] ?></p>
                        <a href="<?php the_permalink(); ?>#frm_services" class="btn btn_eventdetail">イベントの詳細を見る</a>
                    </div>
                </div>
            </div>
        <?php
            endwhile;
            $pagination = get_query_pagination_events();
        endif;
        wp_reset_query();
        ?>
    </div>
