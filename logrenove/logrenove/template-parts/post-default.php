                ...
                <?php
                    ...
                    if($query->have_posts()):
                        ...
                        while($query->have_posts()): $query->the_post();
                            ...
                            ?>
                                <div class="col-6 col-md-6 products_item <?php echo $childNode;?>">
                                    <div class="row no-gutters">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12 products_item_content">
        ...
        <?php 
            if(have_posts()):
                ...
                while(have_posts()): the_post();
                    ...
                    $thumbnails = new ThumbnailItem(get_post_thumbnail_id(), $_size);
                    ?>
                        <div class="col-12 col-md-6 products_item">
                            <div class="row no-gutters">
                                ...
                                <div class="col-7 col-md-12 products_item_content">
                                    <p class="products_item_title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></p>
                                    <p class="btn_badge_cate"><?php echo $firstCat->name; ?></p>
                                </div>
                            </div>
