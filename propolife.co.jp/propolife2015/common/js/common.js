...
/*
    ...
    GL_Propolife.func
        -> GL_Propolife.func.AddGoogleMap // access.js
        -> GL_Propolife.func.SmoothScrollSetPos // home.js
*/
...
//--------------------------------------------------
function AddMask(){
    var mask = '<p class="btm_mask"></p>';
    $('#footer_inner').append(mask);
}
...
function ScrollPageTop(){
    var $btnPagetop = $('#footer .btn_pagetop');
    var moveSpeed = 300;
...
-------------------------------------------------- */
function SwitchUnderIE8(){
    $('body').html('');
    $('body').addClass('underIE');
    $('body').append('<p class="underIE"></p>');
