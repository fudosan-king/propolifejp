...
<div id="section01" class="section">
    <div class="section_inner">
        <a href="https://www.chronicle-web.com/" target="_blank">
            <h3><img src="<?php bloginfo('template_directory'); ?>/common/images/home/img_sec01_title.png" width="511" height="63" alt="CHRONICLE"></h3>
            <p class="pic">
...
<div id="section02" class="section">
    <div class="section_inner">
        <a href="https://www.prostyle-residence.com/" target="_blank">
            <h3><img src="<?php bloginfo('template_directory'); ?>/common/images/home/img_sec02_title.png" width="468" height="63" alt="PROSTYLE"></h3>
            <p class="pic">
                <img src="<?php bloginfo('template_directory'); ?>/common/images/home/img_sec02_pic_<?php echo $current_lang; ?>.jpg" width="330" height="425" alt="" class="pc">
                <img src="<?php bloginfo('template_directory'); ?>/common/images/home/img_sec02_pic_sp_<?php echo $current_lang; ?>.jpg" width="175" alt="" class="sp">
            </p>
            <p class="btn_more">
                <img src="<?php bloginfo('template_directory'); ?>/common/images/home/btn_more.png" width="200" height="50" alt="MORE" class="pc"><img src="<?php bloginfo('template_directory'); ?>/common/images/home/btn_more_sp.png" width="100" alt="MORE" class="sp">
            </p>
...
<div id="section03" class="section">
    <div class="section_inner">
        <a href="https://www.chronicle-plus.com/test-gate-showroom/" target="_blank">
            <h3><img src="<?php bloginfo('template_directory'); ?>/common/images/home/img_sec03_title.png" width="278" height="149" alt="SHOW ROOM"></h3>
            <p class="pic">
                <img src="<?php bloginfo('template_directory'); ?>/common/images/home/img_sec03_pic_<?php echo $current_lang; ?>.jpg" width="330" height="425" alt="" class="pc">
                <img src="<?php bloginfo('template_directory'); ?>/common/images/home/img_sec03_pic_sp_<?php echo $current_lang; ?>.jpg" width="175" alt="" class="sp">
            </p>
            <p class="btn_more">
                <img src="<?php bloginfo('template_directory'); ?>/common/images/home/btn_more.png" width="200" height="50" alt="MORE" class="pc"><img src="<?php bloginfo('template_directory'); ?>/common/images/home/btn_more_sp.png" width="100" alt="MORE" class="sp">
            </p>
