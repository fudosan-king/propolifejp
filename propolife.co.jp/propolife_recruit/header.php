        ...
        <header id="header">
            <div class="hInner clearfix">
                ...
                <nav id="gNavi" class="gNavi">
					<div class="link"><a href="https://line.me/R/ti/p/%40qyp9070z" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/common/img/h_link_0302_on.png" width="20" height="20" alt="LINE"></a></div>
            ...
            <div class="header">
                <div class="hInner clearfix">
                    <h1><a href="https://www.propolife.co.jp/recruit/"><img src="<?php bloginfo('template_directory'); ?>/common/img/logo02.png" width="206" height="40" alt="株式会社プロポライフグループ 「住」に自由とロマンを。"></a></h1>
                    <nav class="gNavi">
                        <div class="link"><a href="https://line.me/R/ti/p/%40qyp9070z" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/common/img/h_link_0302.png" width="20" height="20" alt="LINE"></a></div>
                        <div class="link"><a href="https://twitter.com/proporecruit" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/../../uploads/2018/07/657459_animal_512x512.png" width="16" height="16" alt="Twitter"></a></div>
            ...
            <div class="hBox2 hBox02">
                <div class="subBox">
                    <ul class="clearfix">
                        ...
                        <li>
                            <a href="javascript:void(0);"><img src="<?php bloginfo('template_directory'); ?>/common/img/com_link_yokohama.jpg" width="356" height="98" alt="株式会社プロスタイル横浜"></a>
                            <span></span>
                        </li>
                    </ul>
                </div>
