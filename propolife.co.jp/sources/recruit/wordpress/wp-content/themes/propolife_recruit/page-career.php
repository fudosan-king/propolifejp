...
<?php
    ...
    $recruit_process_image_pc = wp_get_attachment_image_src(get_field('recruit_process_image_pc'), 'large');
    $recruit_process_image_sp = wp_get_attachment_image_src(get_field('recruit_process_image_sp'), 'large');
    $recruit_top_text = get_field('recruit_top_text');
?>
...
$menu_array[] = array('title' => get_the_title(), 'p_link' => get_permalink());
?>
...
<div id="contents_inner">
    ...
    <div id="menu_archives">
        <p class="current"><span class="inner">希望職種を選択してください</span><span class="arrow"></span></p>
        <ul>
<?php foreach($menu_array as $menu): ?>
            <li><a href="<?php echo $menu['p_link']; ?>"><?php echo $menu['title']; ?></a></li>
<?php endforeach; ?>
        </ul>
    </div>
    
    <div id="page_recruit">
        <h3><?php echo $job_category; ?><br>募集要項</h3>
