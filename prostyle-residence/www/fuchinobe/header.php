    ...
    <header class="bsnav-sticky bsnav-sticky-fade">
        <div class="container">
            <div class="navbar navbar-expand-lg bsnav">
                <a class="navbar-brand" href="<?php echo get_site_url() ?>/"><img src="<?php echo get_template_directory_uri() ?>/assets/images/SVG/logo_presis.svg"
                ...
                <div class="collapse navbar-collapse justify-content-sm-end">
                    <ul class="navbar-nav navbar-mobile mr-0">
                        <li class="nav-item"><a target="_blank" class="nav-link"
                                                href="https://www.presis.com/kanagawa/fuchinobe/">公式サイト</a></li>
                        <li class="nav-item"><a target="_blank" class="nav-link"
                        ...
                        <li class="nav-item active"><a target="_blank" class="nav-link"
                                                       href="https://lmp1.net/nwkrdphrawvy2vsimpmsrqsm3bwbsle3/contacts/new">来場予約</a>
                        </li>
                    </ul>
                </div>
            </div>
