<?php get_template_part('template-parts/content/content', 'recommend') ?>
<?php get_template_part('template-parts/content/content', 'otherlineup') ?>
</main>
<footer>
                ...
                <div class="col-12 col-lg-6 offset-lg-3">
                    <div class="row">
                        <div class="col-6 col-lg-6">
                            ...
                            <a target="_blank" href="https://www.hajime-kensetsu.co.jp/"><img
                                        src="<?php echo get_template_directory_uri() ?>/assets/images/1x/ig_logo.png" alt="" class="img-fluid" width="197"></a>
                        </div>
                        <div class="col-6 col-lg-6">
                            <p class="mb-0"><small>共同事業主・販売代理</small></p>
                            <a target="_blank" href="https://www.prostyle-residence.com/"><img src="<?php echo get_template_directory_uri() ?>/assets/images/SVG/logo.svg"
                                                                                               alt="" class="img-fluid"
                                                                                               width="232"></a>
                        </div>
                    </div>
...
<a class="banner_request d-block d-lg-none" href="#"><img src="<?php echo get_template_directory_uri() ?>/assets/images/1x/banner_request.png" alt=""
                                                          class="img-fluid"></a>
