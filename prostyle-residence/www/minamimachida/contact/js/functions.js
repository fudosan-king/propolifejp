...
$(document).ready(function(){
    ...
    $('#goConfirm').click(function(){
        ...
        if(invalidCheck()){
            ...
            dataLayer.push({'event': 'inquiry-confirm'});
            ...
            if(material == '1'){
                (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
                  ...
                  ga('create', 'UA-49090683-16', 'auto', {'allowLinker': true});
                  ga('require', 'linker');
                  ga('linker:autoLink', ['prostyle-residence.com','reg31.smp.ne.jp']);
                  ga('send', 'pageview', {'page': '/request_confirm_minamimachida.html', 'request_confirm_minamimachida': '南町田資料請求フォーム確認画面'});
            }
            ...
            if(reservation == '1'){
                (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
                  ...
                  ga('require', 'linker');
                  ga('linker:autoLink', ['prostyle-residence.com','reg31.smp.ne.jp']);
                  ga('send', 'pageview', {'page': '/reserve_confirm_minamimachida.html', 'reserve_confirm_minamimachida': '南町田来場予約フォーム確認画面'});
            }
