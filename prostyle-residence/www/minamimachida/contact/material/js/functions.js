...
$(document).ready(function(){
    ...
    $('#goConfirm').click(function(){
        ...
        if(invalidCheck()){
            ...
            dataLayer.push({'event': 'inquiry-confirm-minamimachida-material'});
            ...
            (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
              ...
              ga('send', 'pageview', {'page': '/request_confirm_minamimachida.html', 'request_confirm_minamimachida': '南町田来場予約フォーム確認画面'});
