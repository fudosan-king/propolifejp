			...
			<div class="topbanner">
	      	...
	      	<main>
			      								...
			      								<div class="col-12 col-sm-12 col-md-9 align-self-center">
			      									<div class="box_informations_content">
			      										...
			      										<div class="row">
			      											...
			      											<div class="col-9 col-sm-10 align-self-center">
			      												<p>年末年始の休業日につきまして、下記のとおりお知らせいたします。<br>令和元年12月24日(火）～令和2年1月3日(金）<br>1月4日(土）より、通常営業を開始いたします。</p>
			      											</div>
			      										</div>
			      										<div class="row">
			      											<div class="col-3 col-sm-2 align-self-center">
			      											...
			      											<div class="col-9 col-sm-10 align-self-center">
			      												<p>誠に勝手ながら、台風19号接近に伴い、10/12(土)は臨時休業とさせていただきます。<br>尚、10/13(日)の営業についてはお電話にてマンションギャラリーへお問合せください。<br>お手数をお掛けいたしますが、ご理解のほどよろしくお願い申し上げます。</p>
			      											</div>
			      										</div>
			      										<div class="row">
			      											<div class="col-3 col-sm-2 align-self-center">
	      		...
	      		<div class="w_btn_gradient">
					<a href="contact/waitlist/" class="btn btn_gradient btnReserve">
						<p>キャンセル待ちはこちら</p>
					</a>							
	      		</div>
	      	</main>
