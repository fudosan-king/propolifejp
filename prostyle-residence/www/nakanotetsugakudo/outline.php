	      	...
	      	<main>
	      		...
	      		<div class="main_outline">
	      			<div class="container">
	      				<div class="row">
	      					<div class="col-12">
	      						<h2 class="headline">OUTLINE</h2>
					      		<h3 class="subheadline mt-5">「プレシス中野哲学堂パークフロント」物件概要</h3>

					      		<table class="table table-bordered table_outline">
					      			<tr>
					      				<th>名称</th>
					      				<td>プレシス中野哲学堂パークフロント</td>
					      			</tr>
					      			<tr>
					      				<th>所在地</th>
					      				<td>東京都中野区松が丘2丁目62-1番他（地番）、東京都中野区松が丘2丁目31-12（住居表示）</td>
					      			</tr>
					      			<tr>
					      				<th>交通</th>
					      			...
					      			<tr>
					      				<th>地域・地区</th>
					      				<td>第1種住居地域、防火地域、第3種高度地区、<br>
					      				日影規制：4ｈ-2.5ｈ/4.0ｍ、最低敷地60m2、下水道処理区域</td>
					      			</tr>
					      			<tr>
					      				<th>地目</th>
					      				<td>宅地</td>
					      			...
					      			<tr>
					      				<th>建築確認番号</th>
					      				<td>第H29A-JK.eX00894-01号（平成29年10月19日付）</td>
					      			</tr>
					      			<tr>
					      				<th>計画変更建築確認番号</th>
					      				<td>第JAIC2018X9111A2号（平成30年5月9日付）</td>
					      			</tr>
					      			<tr>
					      				<th>総戸数</th>
					      				<td>26戸（他に管理員室1戸）</td>
					      			...
					      			<tr>
					      				<th>駐車場</th>
					      				<td>敷地内に空き1台/総台数3台（機械式3台）（月額使用料：19,000円～22,000円）</td>
					      			</tr>
					      			<tr>
					      				<th>バイク置場</th>
					      				<td>敷地内に5台（月額使用料：1,500円）</td>
					      			</tr>
					      			<tr>
					      				<th>分譲後の権利形態</th>
					      				<td>専有部分は区分所有権、土地及び建物の共用部分は各区分所有権の<br>
					      				専有面積割合による所有権の共有</td>
					      			</tr>
					      			<tr>
					      				<th>売主</th>
					      			...
					      			<tr>
					      				<th>販売代理</th>
					      				<td>ファーストリア株式会社 <br>
					      				国土交通大臣免許（1）第9052号<br>
					      				（公社）東京都宅地建物取引業協会<br>
										（公社）全国宅地建物取引業保証協会<br>
										（公社）首都圏不動産公正取引業協議会 加盟<br>
										東京都不動産協同組合 会員<br>
										〒150-0021 東京都渋谷区恵比寿西1-10-7　MMSビル3F</td>
					      			</tr>
					      			<tr>
					      				<th>設計・監理</th>
					      				<td>株式会社オンズデコ　一級建築士事務所</td>
					      			</tr>
					      			<tr>
					      				<th>施工会社</th>
					      				<td>菊池建設株式会社</td>
					      			...
					      			<tr>
					      				<th>竣工時期</th>
					      				<td>2019年1月10日（竣工済）</td>
					      			</tr>
					      			<tr>
					      				<th>入居時期</th>
					      				<td>即入居可（各種手続完了後の入居となります）</td>
					      			</tr>
					      			<tr>
					      				<th>設計図書閲覧場所</th>
					      				<td>プレシス中野哲学堂パークフロント　現地販売センター</td>
					      			</tr>
					      			<tr>
					      				<th>管理形態</th>
					      		...
					      		<h3 class="subheadline mt-5">「プレシス中野哲学堂パークフロント」先着順販売概要</h3>
					      		<table class="table table-bordered table_outline">
					      			<tr>
					      				<th>販売戸数</th>
					      				<td>5戸</td>
					      			...
					      			<tr>
					      				<th>管理費（月額）</th>
					      				<td>15,305円〜22,715円 ※インターネット・TV使用料含む</td>
					      			</tr>
					      			<tr>
					      				<th>修繕積立金（月額）</th>
					      				<td>3,160円〜5,110円</td>
					      			...
					      			<tr>
					      				<th>管理準備金（引渡時一括）</th>
					      				<td>14,755円〜22,165円</td>
					      			</tr>
					      			<tr>
					      				<th>修繕積立基金（引渡時一括）</th>
					      				<td>211,720円〜342,370円</td>
					      			</tr>
					      			<tr>
					      				<th>備考</th>
					      			...
					      			<tr>
					      				...
					      				<td>
											<div class="mb-4">
												<p>■支払い例 Bタイプ [3LDK（54.86㎡）] 5490万円の場合</p>
												<p>毎月の支払い額／139,461円</p>
												<p>ボーナス時加算額／0円</p>
												<p>頭金／90万円</p>
												<p>借入金の月々の元本／5400万円</p>
												<p>借入金のボーナス払いの元本／0円</p>
											</div>

											<div class="mb-4">
												<p>■支払い例 Cタイプ [2DK（39.44㎡）] 3890万円の場合</p>
												<p>毎月の支払い額／98,139円</p>
												<p>ボーナス時加算額／0円</p>
												<p>頭金／90万円</p>
												<p>借入金の月々の元本／3800万円</p>
												<p>借入金のボーナス払いの元本／0円  </p>
											</div>
											...
											<div class="">
												...
												<p>提携ローン</p>
												<p>提携金融機関／りそな銀行</p>
												<p>販売価格に対する融資限度額の割合／100％以内</p>
												<p>融資限度額／50万円以上１億円以内（10万円単位）</p>
												<p>返済期間／1年～35年</p>
												<p>利率／年利0.47％（変動金利）（店頭金利2.475%より全期間-2.005％）</p>
												<p>融資事務手数料／お借入金額の2.2％</p>
												<p>※ローンは一定要件該当者が対象です。適用される金利は融資実行時のものとなり、表記されている金利と異なる場合があります。</p>
											</div>
					      				</td>
					      			</tr>
					      		</table>
					      		...
					      		<p class="mb-5 text-center">情報提供日：<span>2019/9/30</span>　次回更新予定日：<span>2019/10/31</span></p>
