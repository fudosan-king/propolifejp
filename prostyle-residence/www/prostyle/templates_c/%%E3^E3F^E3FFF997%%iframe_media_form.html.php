<?php /* Smarty version 2.6.27, created on 2015-03-17 14:31:39
...
&amp;type=iframe"><!--<?php if (((is_array($_tmp=$this->_tpl_vars['freo']['query']['path'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp))): ?>-->この階層の<!--<?php endif; ?>-->メディアを一欄表示する</a>。</li>
	</ul>
...
" />
			<input type="hidden" name="type" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['freo']['query']['type'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
...
&amp;path=<?php echo ((is_array($_tmp=$this->_tpl_vars['freo']['query']['path'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
&amp;type=iframe" method="post" enctype="multipart/form-data">
		<fieldset>
