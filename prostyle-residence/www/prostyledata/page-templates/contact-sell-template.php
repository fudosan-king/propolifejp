<?php 
/* Template Name: Contact Sell Pardot Form - Page Template */
?>

<?php get_header();?>

<main>
	<section class="content-page contact sell">
		<div class="container">
			<div class="row">
								...
								<section class="extra-content">
									...
									<div id="contents_inner">
										...
										<?php if(isset($_GET['finish']) && $_GET['finish'] == 1): ?>
											...
											<form action="https://go.pardot.com/l/185822/2019-01-14/ctg1zz" method="POST" role="form" class="frm_contact">
												...
												<section class="defaultForm">
													...
													<legend>■査定方法・ご相談内容の種別</legend>
							                        <dl class="Rtable Rtable--3cols Rtable--collapse table_register web_info">

							                            <dt class="Rtable-cell Rtable-cell--medium Flex-center--right"><strong>ご希望の査定方法 <span class="red">＊</span></strong></dt>
							                            <dd class="Rtable-cell Rtable-cell--highlight Rtable-cell--2of3 Rtable-cell--rowEnd">
							                                <div class="row">
							                                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 Flex-center">
					                                    			 <div class="radio">
							                                        	<label>
							                                        		<input type="radio" name="satei_type[]" id="satei_type_1" value="訪問査定" checked onchange="">
							                                        		訪問査定
							                                        	</label>
							                                        </div>
					                                    		</div>
						                                       	...
						                                       	<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
						                                       		<div class="card">
					                                        			<div class="card-block">
					                                        				<p class="card-text">
					                                        					実際に査定をご希望される物件の現地を訪問し、実際の物件の状況等を確認の上、具体的な査定を行うことができます。
																			</p>
					                                        			</div>
					                                        		</div>
						                                       	</div>
							                               ...
							                               <br>
							                                <div class="row">
							                                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 Flex-center">
					                                    			 <div class="radio">
							                                        	<label>
							                                        		<input type="radio" name="satei_type[]" id="satei_type_2" value="簡易査定" onchange="">
							                                        		簡易査定
							                                        	</label>
							                                        </div>
					                                    		</div>
						                                       	...
						                                       	<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
						                                       		<div class="card">
					                                        			<div class="card-block">
					                                        				<p class="card-text">
					                                        					お客様よりお伝えいただいた物件に関する情報と、周辺の売出事例、成約事例等から概算の査定を行います。
																			</p>
					                                        			</div>
					                                        		</div>
						                                       	</div>
							                        ...
							                        <legend>■査定対象物件の情報をご入力ください。</legend>
							                        <dl class="Rtable Rtable--3cols Rtable--collapse table_register web_info">

							                        	<dt class="Rtable-cell Rtable-cell--medium"><strong>物件の種別 <span class="red">＊</span></strong></dt>
							                            <dd class="Rtable-cell Rtable-cell--highlight Rtable-cell--2of3 Rtable-cell--rowEnd">
							                                <div class="row">
							                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					                                    			 <div class="radio">
							                                        	<label>
							                                        		<input type="radio" name="estate_type[]" id="estate_type_1" value="マンション" checked onchange="">
							                                        		マンション
							                                        	</label>
							                                        </div>
					                                    		</div>
							                                ...
							                                <div class="row">
							                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					                                    			 <div class="radio">
							                                        	<label>
							                                        		<input type="radio" name="estate_type[]" id="estate_type_2" value="一戸建て" onchange="">
							                                        		一戸建て
							                                        	</label>
							                                        </div>
					                                    		</div>
							                                ...
							                                <div class="row">
							                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					                                    			 <div class="radio">
							                                        	<label>
							                                        		<input type="radio" name="estate_type[]" id="estate_type_3" value="土地" onchange="">
							                                        		土地
							                                        	</label>
							                                        </div>
					                                    		</div>
							                                ...
							                                <div class="row">
							                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					                                    			 <div class="radio">
							                                        	<label>
							                                        		<input type="radio" name="estate_type[]" id="estate_type_4" value="その他" onchange="">
							                                        		その他
							                                        	</label>
							                                        </div>
					                                    		</div>
							                            ...
							                            <dt class="Rtable-cell Rtable-cell--medium"><strong>物件所在地  <span class="red">＊</span></strong></dt>
							                            <dd class="Rtable-cell Rtable-cell--highlight Rtable-cell--2of3 Rtable-cell--rowEnd">
							                                <div class="row">
							                                    <div class="col-lg-3">
							                            ...
							                            <dt class="Rtable-cell Rtable-cell--medium">
							                                <p>その他、ご希望・ご質問・物件に関しての追加情報等ございましたらご記入ください。</p>
							                            </dt>
							                            <dd class="Rtable-cell Rtable-cell--highlight Rtable-cell--2of3 Rtable-cell--rowEnd">
							                            ...
							                            <input type="hidden" name="madori" id="madori" class="form-control" value="">
							                            <input type="hidden" name="shiire_exclusive_area" id="shiire_exclusive_area" class="form-control" value="">
							                            <input type="hidden" name="shiire_sqm" id="shiire_sqm" class="form-control" value="">
						                        ...
						                        <section class="confirmForm">
							                        ...
							                        <dl class="Rtable Rtable--3cols Rtable--collapse">
							                            ...
							                            <dt class="Rtable-cell Rtable-cell--medium"><strong>ご希望の査定方法  <span class="red">＊</span></strong></dt>
							                            <dd class="Rtable-cell Rtable-cell--highlight Rtable-cell--2of3 Rtable-cell--rowEnd">
							                                <div class="row  cfrm_satei_type">
							                        ...
							                        <dl class="Rtable Rtable--3cols Rtable--collapse">
							                            ...
							                            <dt class="Rtable-cell Rtable-cell--medium"><strong>物件の種別  <span class="red">＊</span></strong></dt>
							                            <dd class="Rtable-cell Rtable-cell--highlight Rtable-cell--2of3 Rtable-cell--rowEnd">
							                                <div class="row  cfrm_estate_type">
							                            ...
							                            <dt class="Rtable-cell Rtable-cell--medium"><strong>その他、ご希望・ご質問・物件に関しての追加情報等ございましたらご記入ください。</strong></dt>
							                            <dd class="Rtable-cell Rtable-cell--highlight Rtable-cell--2of3 Rtable-cell--rowEnd">
