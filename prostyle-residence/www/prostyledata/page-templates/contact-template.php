<?php 
/* Template Name: Contact Pardot Form - Page Template */
?>
							...
							<div id="main-content">
								...
								<section class="extra-content">
									...
									<div id="contents_inner">
										...
										<form action="https://go.pardot.com/l/185822/2019-01-03/cr647z" method="POST" role="form" class="frm_contact">
					                                        ...
					                                        <div class="form-group">
					                                            <ul class="list_interest">
					                                                <li>
					                                                    <div class="radio">
					                                                        <label>
					                                                            <input type="radio" name="category_contact[]" id="" value="物件に関するお問い合わせ" checked="checked" onchange=""> 物件に関するお問い合わせ
					                                                        </label>
					                                                    </div>
					                                                </li>
					                                                <li>
					                                                    <div class="radio">
					                                                        <label>
					                                                            <input type="radio" name="category_contact[]" id="category_contact_1" value="不動産買取りに関するお問い合わせ" onchange=""> 不動産買取りに関するお問い合わせ
					                                                        </label>
					                                                    </div>
					                                                </li>
					                                                <li>
					                                                    <div class="radio">
					                                                        <label>
					                                                            <input type="radio" name="category_contact[]" id="category_contact_2" value="アフターサービスに関するお問い合わせ" onchange=""> アフターサービスに関するお問い合わせ
					                                                        </label>
					                                                    </div>
					                                                </li>
					                                                <li>
					                                                    <div class="radio">
					                                                        <label>
					                                                            <input type="radio" name="category_contact[]" id="category_contact_3" value="取材・撮影に関するお問い合わせ" onchange=""> 取材・撮影に関するお問い合わせ
					                                                        </label>
					                                                    </div>
					                                                </li>
					                                                <li>
					                                                    <div class="radio">
					                                                        <label>
					                                                            <input type="radio" name="category_contact[]" id="category_contact_4" value="その他サービスに関するお問い合わせ" onchange=""> その他サービスに関するお問い合わせ
					                                                        </label>
					                                                    </div>
					                                                </li>
					                                                <li>
					                                                    <div class="radio">
					                                                        <label>
					                                                            <input type="radio" name="category_contact[]" id="category_contact_5" value="プライバシーポリシーに関するお問い合わせ" onchange="">
