                    ...
                    <?php
                        if(have_rows('list_project_flexible')):
                            ...
                            while(have_rows('list_project_flexible')): the_row();
                                ...
                                $colOffset = count(get_field('list_project_flexible')) < 3 && $count==1 ? "offset-md-".(12 - count(get_field('list_project_flexible'))*4)/2 : '';
                                ?>
                                    <div class="col-12 col-md-4 <?php echo $colOffset; ?>">
