<?php 
	if (have_rows('distribution_control')):
		echo '
			<section class="section_distribution_record bg_common">
				<div class="w_section_distribution_record">
					<div class="container">
						<div class="row">
							<div class="col col-sm-12">
								<h2 class="headline"><img src="'.SGVinK::get_images_uri().'bunjo.png" height="35" class="img-responsive" alt="Image"></h2>
