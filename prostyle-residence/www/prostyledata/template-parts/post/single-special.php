                ...
                <div class="col-12">
                    ...
                    <div class="box_ryokan_topimg mx-auto text-left">
                        ...
                        <a href="https://www.prostyleryokan.com/yokohamabashamichi/" target="_blank">
                            <img src="<?php echo SGVinK::get_images_uri();?>1x/bashamichi_banner.png" alt="" class="img-fluid">
                        </a>
                        
                        <p class="d-none d-md-block" style="text-align: left;">おかげさまで、プロスタイル旅館は2019年「グッドデザイン賞」を受賞いたしました。<br>
                        ...
                        <p class="d-block d-md-none" style="text-align: left;">おかげさまで、プロスタイル旅館は2019年「グッドデザイン賞」を <br>
                            受賞いたしました。 <br>
                            グッドデザイン賞は、日本で唯一の総合的なデザイン評価・推奨の仕組みです。人が何らかの理想や目的を果たすために築いたものごとをデザインととらえ、その質を評価・顕彰している評価制度です。<br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="description">プロスタイル旅館横浜⾺⾞道は、数多くの歴史的洋館建造物が現存する横浜馬車道で、「まちなか旅館」をテーマに、畳や格⼦・障⼦といった⽇本的⽂化とノスタルジックな雰囲気漂う瀟洒な西洋の街並みが、過去と現代、⻄洋と⽇本の和洋折衷を「⼼地よさ」と感じさせる現代的に再解釈した宿泊施設です。</p>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="concept_item">
                            ...
                            <p>横浜馬車道の煉瓦舗装された道から引用したレンガ、 横浜馬車道が日本の近代街路樹の発祥地とされることから引用した木を工夫しつつ用いた、周辺への調和だけでなく、新しさも融合させた外観。</p>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="concept_item">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="concept_item">
                                    ...
                                    <p>横浜馬車道の歴史的建造物の石造りをイメージする内装カラ一を用い、照度を抑えた明かりは横浜馬車道に日本初のガス灯が灯った当時をほのかに感じられる空間。</p>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="concept_item">
                ...
                <div class="col-12 col-md-8 mx-auto">
                    <div class="table_outline">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-10 col_custom">
                                <p>プロスタイル旅館横浜⾺⾞道は、数多くの歴史的洋館建造物が現存する横浜馬車道で、「まちなか旅館」をテーマに、畳や格⼦・障⼦といった⽇本的⽂化とノスタルジックな雰囲気漂う瀟洒な西洋の街並みが、 過去と現代、⻄洋と⽇本の和洋折衷を「⼼地よさ」と感じさせる現代的に再解釈した宿泊施設です。</p>
                            </div>
                            <div class="col-12 col-md-2 col_custom label_custom">
                                <p>プロデューサー</p>
                            </div>
