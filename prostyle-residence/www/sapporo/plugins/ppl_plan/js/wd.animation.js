var txt_modCont             = "#ppl_plan-container > #ppl_plan-container-holder";  
touchDevice = 0 ;
    ...
    function afterGalleryStartupAnimation( visibleH ){
        ...
        var textPageInstance          = jQuery( "#ppl_plan-galleries", textPageInstanceHolder);
        if( textPageInstance.length <= 0){return;}
        jQuery("#ppl_plan-galleries-holder", textPageInstance).find(".thumb-holder").each( function(){ jQuery(this).css("display", "inline"); } ); 
        jQuery("#ppl_plan-galleries-preview").wipetouch({
	...
	function moduleGallery(){
	    ...
	    var textPageInstanceHolder = jQuery( txt_modCont );
        var textPageInstance          = jQuery( textPageInstanceHolder ).children('#ppl_plan-galleries');//jQuery( "#ppl_plan-galleries", textPageInstanceHolder);
        if( textPageInstance.length <= 0 ){return;}       
        ...
        var galleryHolder       = jQuery("#ppl_plan-galleries-holder", textPageInstance);
		...
		var gallery_width 		= jQuery("#ppl_plan-galleries-holder").width();
		var item_width			= jQuery("#ppl_plan-galleries-holder").children('.item:first').width();
       ...
       // moduleUpdate( textPageInstanceHolder, textPageInstance, jQuery("div:first", textPageInstance), sideType );
        ...
        var galleryItem         = jQuery("#ppl_plan-galleries-holder .thumb-holder", textPageInstance);
