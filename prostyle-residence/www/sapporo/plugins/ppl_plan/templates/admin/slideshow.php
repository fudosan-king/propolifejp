<?php
global $post;
$ppl_plan_slider = get_post_meta($post->ID,'_wd_slider',true);
$ppl_plan_slider = unserialize($ppl_plan_slider);
?>
...
<div class="uploader">
	...
	<div class="sortable-wrapper">
		<ul id="sortable">
			<?php
			if( is_array($ppl_plan_slider) && count($ppl_plan_slider) > 0 ):
				foreach( $ppl_plan_slider as $single_slider ):
			?>
				<li>
