...
>>>>>>> No. 125141 新規作成・リニュアル_業務依頼 （プロスタイル宮の森(仮)販売サイト作成）| front end
                        ...
                        <section class="form_info  frm_confirm" style="display: none;">
                            <!-- 会社名 -->
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="end-form" style="width: 100%;">
                                        <button type="button" class="btn w-25 btn_brown " id="goBack" value="戻る"> 戻る</button>
                                        <button type="button" class="btn w-25 btn_brown " id="goSubmit" value="送信する">送信する</button>
                                    </div>
                                </div>
                            </div>
                        </section>
