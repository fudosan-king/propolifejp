...
<section id="section_living" class="section_living">
    ...
    <section class="section_spring_summer">
        <img src="<?php bloginfo('template_directory');?>/assets/images/1x/bg_spring_summer.png" alt="" class="img-fluid">
        <div class="container">
            <div class="row">
    ...
    <section class="section_area_minyanomori">
        <img src="<?php bloginfo('template_directory');?>/assets/images/1x/miyanomori_area.jpg" alt="" class="img-fluid">
            ...
            <div class="row no-gutters">
                <div class="col-12 col-lg-7">
                    <div class="interview_img">
                        <img src="<?php bloginfo('template_directory');?>/assets/images/1x/mr_kengokuma02.jpg" alt="" class="img-fluid" width="587">
                    </div>
