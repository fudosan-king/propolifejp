<header>
    <div class="navbar navbar-expand-md bsnav bsnav-sticky bsnav-sticky-slide">
        <a class="navbar-brand" href="<?=home_url();?>/">
            ...
            <img src="<?php the_img_path(); ?>/nahakenchomae.png" alt="" class="img-fluid d-none d-md-block" width="186">
            <img src="<?php the_img_path(); ?>/nahakenchomae.png" alt="" class="img-fluld d-block d-md-none" width="186">
        </a>
