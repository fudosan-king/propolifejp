		...
		<div class="row">
			<div class="col-12">
				<div class="box_concept">
					<div class="row flex-column-md-reverse flex-md-row">
						<div class="col-12 col-md-7">
							<!-- <img src="<?php _echo($data->background->url); ?>" alt="" class="w-100 h-100" style="object-fit: cover;"> -->
							<div 
							class="bg-fit w-100 h-100" 
							style="background-image: url(<?php _echo($data->background->url); ?>); background-size: cover; background-position: center;"></div>
						</div>
