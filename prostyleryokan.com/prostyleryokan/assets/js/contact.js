    ...
    $.each(elemsChk, function(key, elem){
        ...
        if(typeof($(this)) !== 'undefined' && $(this).prop('type')=='checkbox'){
            ...
            if(typeof(elem.val()) === 'undefined' || elem.val() == "" || elem.val() == "null"){
                ...
                if(elem.prop('name') == 'post'){
                    $('.error-text.post').html(ERROR_NO_INPUT);
                    $('.error-text.post').css('display', 'block');
                }

                if(elem.prop('name') == 'pref'){
                    $('.error-text.pref').html(ERROR_NO_INPUT);
                    $('.error-text.pref').css('display', 'block');
                }

                if(elem.prop('name') == 'city'){
                    $('.error-text.city').html(ERROR_NO_INPUT);
                    $('.error-text.city').css('display', 'block');
                }
...
$(document).ready(function(){
    ...
    $('.indentityLocation').click(function(event) {
        /* Act on the event */
        AjaxZip3.zip2addr('post','','pref','city');
    });
    ...
    $('#goConfirm').click(function(){
        ...
        if(invalidCheck()){
            ...
            $('.content_register').fadeOut();
            $('.content_confirm').fadeIn(function(){
                 $('body').scrollTop(0);
            });
            ...
            var cfrm_firstimpression = $('input[name="category_contact[]"]:checked').val();
    ...
    $('#goBack').click(function(){
        $('.content_register').fadeIn(function(){
            $('html').scrollTop(0);
        });
        $('.content_confirm').fadeOut();
    });
