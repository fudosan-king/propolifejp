...
$logo_footer_content = $footer_info['bottom_content'];
$logo_footer_link = !empty($logo_footer_content['logo_footer_link']) ? $logo_footer_content['logo_footer_link']['url'] : '/' ;
$logo_footer_link_target = !empty($logo_footer_content['logo_footer_link']) ? $logo_footer_content['logo_footer_link']['target'] : '' ;
?>
	...
	<div class="container">
		<div class="row">
			<div class="col col-12">
				<a href="<?php echo $logo_footer_link; ?>" class="logo_footer" targer="<?php echo $logo_footer_link_target; ?>">
