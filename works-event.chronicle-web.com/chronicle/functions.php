...
define('TEMPLATE_ASSETS', get_stylesheet_directory_uri());
	...
	add_image_size( 'thumb', 101, 80, true);
	add_image_size( 'detail', 400, 260, true);
	add_image_size( 'madori', 478, 288, false);
	add_image_size( 'voice', 150, 160, true);
	add_image_size( 'list', 310, 200, true);
	add_image_size( 'event_list', 180, 150, true);
