...
define('WP_SITEURL', 'https://works-event.chronicle-web.com');
define('WP_HOME', 'https://works-event.chronicle-web.com');

// Disable SSL and can run in localhost dev environment
// define('WP_SITEURL', 'http://works-event.chronicle-web.com');
// define('WP_HOME', 'http://works-event.chronicle-web.com');
